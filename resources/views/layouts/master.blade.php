...
<head>
    ...
    <!-- Base Css Files -->
    <link rel="stylesheet"
        href="{{ asset('admin/assets/libs/jqueryui/ui-lightness/jquery-ui-1.10.4.custom.min.css') }}">
    ...
    <div id="wrapper">
        ...
        <div class="topbar">
            <div class="topbar-left">
                <div class="logo">
                    <h1><a href="{{ route('welcome') }}"><img src="{{ asset('admin/assets/images/logo.png') }}"></a>
                    </h1>
                </div>
                ...
                <div class="container">
                    <div class="navbar-collapse2">
                        <ul class="nav navbar-nav navbar-right top-navbar">
                            <li class="iconify hide-phone"><a href="javascript:void(0);" class="font-12 text-base">Rate
                                    Calculator</a></li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);"
                                    class="font-12 text-base">Guides</a></li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);" class="font-12 text-base">One
                                    Balance and Carriers</a></li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);" class="font-12 text-base">Ready
                                    to Print</a></li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);"><i class="icon-cog"></i>
                                    Settings</a></li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);"><i class="icon-bell"></i></a>
                            </li>
                            <li class="iconify hide-phone"><a href="javascript:void(0);"
                            ...
                            <li class="dropdown topbar-profile">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="{{ route('auth.logout') }}"><i class="icon-logout-1"></i> Logout</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
