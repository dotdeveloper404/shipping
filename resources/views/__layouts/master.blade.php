...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>KL Fulfillment Inc.</title>
    ...
    <link href="theme/assets/css/pages/wizard/wizard-2.css" rel="stylesheet" type="text/css">
    ...
    <link href="theme/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
    <link href="theme/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
    <link href="theme/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
    <link href="theme/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
    <!--end::Layout Themes-->
    ...
    <style>
        ...
        .aside-menu .menu-nav>.menu-item.menu-item-active>.menu-link {
            background-color: #246384 !important;
        }
...
<body id="kt_body"
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4 " data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav ">
                            ...
                            <li class="menu-item " aria-haspopup="true"><a href="{{route('edit-profile')}}"
                                    class="menu-link "><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Profile</span></a></li>
                            ...
                            <li class="menu-item  menu-item-active" aria-haspopup="true"><a href="index.html"
                                    class="menu-link "><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Welcome</span></a></li>


                            <li class="menu-item  menu-item" aria-haspopup="true"><a href="index.html"
                                    class="menu-link "><span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Quick Ship</span></a></li>
                            ...
                            <li class="menu-item  menu-item" aria-haspopup="true"><a href="index.html"
                                    class="menu-link "><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Orders</span></a></li>
                            ...
                            <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                                    href="javascript:;" class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Shipments</span><i
                                        class="menu-arrow"></i></a>
                                <div class="menu-submenu "><i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                                                class="menu-link"><span class="menu-text">Shipments</span></span>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    ...
                                                    class="menu-text">Ready to Ship</span><span class="menu-label"><span
                                                        class="label label-danger label-inline">3</span></span></a>
                                        </li>

                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Ready for Payment</span><span
                                                    class="menu-label"><span
                                                        class="label label-danger label-inline">4</span></span></a>
                                        </li>

                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Ready to Print</span><span
                                                    class="menu-label"><span
                                                        class="label label-danger label-inline">31</span></span></a>
                                        </li>
                            ...
                            <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                                    href="javascript:;" class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Products</span><i
                                        class="menu-arrow"></i></a>
                                <div class="menu-submenu "><i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                                                class="menu-link"><span class="menu-text">Products</span></span>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Product Catalog</span><span
                                                    class="menu-label"><span
                                                        class="label label-success label-inline">150</span></span></a>
                                        </li>
                            ...
                            <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                                    href="javascript:;" class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Marketing</span><i
                                        class="menu-arrow"></i></a>
                                <div class="menu-submenu "><i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                                                class="menu-link"><span class="menu-text">Marketing</span></span>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Marketing Dashboard</span><span
                                                    class="menu-label"></span></a>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Email Campaigns</span><span
                                                    class="menu-label"></span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Signup Forms</span><span
                                                    class="menu-label"></span></a>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Product Recommendations</span><span
                                                    class="menu-label"></span></a>
                                        </li>
                            ...
                            <li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"><a
                                    href="javascript:;" class="menu-link menu-toggle"><span class="svg-icon menu-icon">
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Reports</span><i
                                        class="menu-arrow"></i></a>
                                <div class="menu-submenu "><i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item  menu-item-parent" aria-haspopup="true"><span
                                                class="menu-link"><span class="menu-text">Reports</span></span>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Snapshots</span><span
                                                    class="menu-label"></span></a>
                                        </li>
                                        ...
                                        <li class="menu-item " aria-haspopup="true"><a href="custom/apps/inbox.html"
                                                class="menu-link "><i
                                                    class="menu-bullet menu-bullet-line"><span></span></i><span
                                                    class="menu-text">Exports</span><span class="menu-label"></span></a>
                                        </li>
                            ...
                            <li class="menu-item  menu-item-active" aria-haspopup="true"><a href="{{url('/logout')}}"
                                    class="menu-link "><span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                        ...
                                        <!--end::Svg Icon--></span><span class="menu-text">Sign Out</span></a></li>
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="header  header-fixed ">
                    ...
                    <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
                        ...
                        <!--begin::Topbar-->
                        <div style="display: none;" class="topbar">
                            <!--begin::Search-->
                            ...
                            <div class="row">
                                ...
                                <div class="card card-custom">
                                    <div class="card-body p-0">
                                        <!--begin: Wizard-->
                                        <div class="wizard wizard-2" id="kt_wizard" data-wizard-state="first"
                                                ...
                                                <div class="wizard-steps">
                                                    ...
                                                    <div class="wizard-step" data-wizard-type="step"
                                                        ...
                                                        <div class="wizard-wrapper">
                                                            <div class="wizard-icon">
                                                                <span class="svg-icon svg-icon-2x">
                                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Map/Compass.svg--><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                        width="24px" height="24px" viewBox="0 0 24 24"
                                                                        version="1.1">
                                            ...
                                            <!--begin: Wizard Body-->
                                            <div class="wizard-body py-8 px-8 py-lg-20 px-lg-30">
                                                <!--begin: Wizard Form-->
                                                <div class="row">
                                                        ...
                                                        <form class="form fv-plugins-bootstrap fv-plugins-framework"
                                                            ...
                                                            <div class="pb-5" data-wizard-type="step-content"
                                                                ...
                                                                <h4 class="mb-10 font-weight-bold text-dark">
                                                                    Confirm Your Store Settings<br>
                                                                    <span style="font-size:12px;" class="md-8">Before we
                                                                        add your orders, please make sure
                                                                        everything looks good below</span>
                                                                </h4>
                                                                <hr />
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-lg"
                                                                        name="lname" placeholder="city" value="">
                                                                    <span class="form-text text-muted">Please enter your
                                                                        city.</span>
                                                                    <div class="fv-plugins-message-container"></div>
                                                                </div>
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-lg"
                                                                        name="lname" placeholder="state" value="">
                                                                    <span class="form-text text-muted">Please enter your
                                                                        state.</span>
                                                                    <div class="fv-plugins-message-container"></div>
                                                                </div>
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control form-control-solid form-control-lg"
                                                                        name="lname" placeholder="zip" value="">
                                                                    <span class="form-text text-muted">Please enter your
                                                                        zip.</span>
                                                                    <div class="fv-plugins-message-container"></div>
                                                                </div>
                                                            ...
                                                            <!--begin: Wizard Step 2-->
                                                            <div class="pb-5" data-wizard-type="step-content">
                                                                <h4 class="mb-10 font-weight-bold text-dark">Select a
                                                                    label layout
                                                                </h4>
                                                                <p>Choose a domestic label size and format that best
                                                                    matches your printer.</p>
                                                                <h4 />
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        <!--begin::Input-->
                                                            ...
                                                            <div class="pb-5" data-wizard-type="step-content">
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <select name="delivery"
                                                                        ...
                                                                        <option value="overnight" selected="">Overnight
                                                                            Delivery (within 48 hours)
                                                                        </option>
                                                                        <option value="express">Express Delivery (within
                                                                            5 working days)</option>
                                                                        <option value="basic">Basic Delivery (within 5 -
                                                                            10 working days)</option>
                                                                    </select>
                                                                    <div class="fv-plugins-message-container"></div>
                                                                </div>
                                                                <!--end::Select-->
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <select name="packaging"
                                                                        ...
                                                                        <option value="regular" selected="">Regular
                                                                            Packaging</option>
                                                                        <option value="oversized">Oversized Packaging
                                                                        </option>
                                                                        <option value="fragile">Fragile Packaging
                                                                        </option>
                                                                ...
                                                                <div class="form-group fv-plugins-icon-container">
                                                                    ...
                                                                    <select name="preferreddelivery"
                                                                        class="form-control form-control-solid form-control-lg">
                                                                        <option value="">Select a Preferred Delivery
                                                                            Option</option>
                                                                        <option value="morning" selected="">Morning
                                                                            Delivery (8:00AM - 11:00AM)</option>
                                                                        <option value="afternoon">Afternoon Delivery
                                                                            (11:00AM - 3:00PM)</option>
                                                            ...
                                                            <!--begin: Wizard Step 4-->
                                                            <div class="pb-5" data-wizard-type="step-content">
                                                                <h4 class="mb-10 font-weight-bold text-dark">Setup Your
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control form-control-solid form-control-lg"
                                                                                name="locstate" placeholder="State"
                                                                                value="VIC">
                                                                            <span class="form-text text-muted">Please
                                                                                enter your state.</span>
                                                                            <div class="fv-plugins-message-container">
                                                            ...
                                                            <!--begin: Wizard Step 5-->
                                                            <div class="pb-5" data-wizard-type="step-content">
                                                                <h4 class="mb-10 font-weight-bold text-dark">Enter your
                                                                    Payment Details</h4>
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        <!--begin::Input-->
                                                            ...
                                                            <div class="pb-5" data-wizard-type="step-content">
                                                                <!--begin::Section-->
                                                                <h4 class="mb-10 font-weight-bold text-dark">Review your
                                                                    Details and Submit</h4>
                                                                ...
                                                                <div class="text-dark-50 line-height-lg">
                                                                    <div>Package: Complete Workstation (Monitor,
                                                                        Computer, Keyboard &amp; Mouse)</div>
                                                                    <div>Weight: 25kg</div>
                                                                    <div>Dimensions: 110cm (w) x 90cm (h) x 150cm (L)
                                                                    </div>
                                                                </div>
                                                                <div class="separator separator-dashed my-5"></div>
                                                                <!--end::Section-->
                                                                ...
                                                                <div class="text-dark-50 line-height-lg">
                                                                    ...
                                                                    <div>Preferred Morning (8:00AM - 11:00AM) Delivery
                                                                    </div>
                                                                </div>
                                                                <div class="separator separator-dashed my-5"></div>
                                                                <!--end::Section-->
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="" target="_blank" class="text-dark-75 text-hover-primary">KL Fulfillment Inc.</a>
                        </div>
                        <!--end::Copyright-->
    ...
    <ul style="display: none;" class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
        <!--begin::Item-->
    ...
    <script src="theme/assets/js/pages/custom/wizard/wizard-2.js"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
