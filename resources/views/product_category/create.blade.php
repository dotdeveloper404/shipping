                ...
                <div class="widget-content">
                    <div class="table-responsive">
                        <div class="widget">
                            ...
                            <div class="widget-header transparent">
                                <h2><strong>Add Product Category</strong> Form</h2>
                            </div>
                            <div class="widget-content padding">
                                <div id="basic-form">
                                    <form method="POST" enctype="multipart/form-data"
                                        action="{{route('category.store')}}" role="form">
                                        @csrf
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="dimension_l" class="form-control"
                                                    id="" placeholder="L">
                                                <input type="text" required name="dimension_w" class="form-control"
                                                    id="" placeholder="W">

                                                <input type="text" required name="dimension_h" class="form-control"
                                                    id="" placeholder="H">
                                            </div>
